    ...
    return Row(
      ...
      children: [
        ...
        DropdownButton(
            items: [
              DropdownMenuItem(
                  value: 'libx264', child: Text(NyxVideoCodec.h264.name)),
              DropdownMenuItem(
                  value: 'libx265', child: Text(NyxVideoCodec.h265.name)),
              DropdownMenuItem(
                  value: 'libxvid', child: Text(NyxVideoCodec.xvid.name)),
              DropdownMenuItem(
                  value: 'libvpx', child: Text(NyxVideoCodec.vp8.name)),
              DropdownMenuItem(
                  value: 'libvpx-vp9', child: Text(NyxVideoCodec.vp9.name)),
              DropdownMenuItem(
                  value: 'libaom-av1', child: Text(NyxVideoCodec.av1.name)),
              DropdownMenuItem(
                  value: 'mpeg4', child: Text(NyxVideoCodec.mpeg4.name)),
              DropdownMenuItem(
                  value: 'mpeg2video', child: Text(NyxVideoCodec.mpeg2.name)),
            ],
            value: dropdownValue,
